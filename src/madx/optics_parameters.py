...
def compute_v_x(bunch_configuration, path_to_configuration):
    reference_particles = ptg.generate_from_range(bunch_configuration, path_to_configuration)
    ...
    shifted_particles = ptg.generate_from_range(bunch_configuration, path_to_configuration)
...
def compute_v_y(bunch_configuration, path_to_configuration):
    reference_particles = ptg.generate_from_range(bunch_configuration, path_to_configuration)
...
def compute_l_x(bunch_configuration, path_to_configuration):
    reference_particles = ptg.generate_from_range(bunch_configuration, path_to_configuration)
...
def compute_l_y(bunch_configuration, path_to_configuration):
    reference_particles = ptg.generate_from_range(bunch_configuration, path_to_configuration)
...
def compute_d_x(bunch_configuration, path_to_configuration):
    reference_particles = ptg.generate_from_range(bunch_configuration, path_to_configuration)
...
def compute_d_y(bunch_configuration, path_to_configuration):
    reference_particles = ptg.generate_from_range(bunch_configuration, path_to_configuration)
