...
def compute_v_x(approximator, bunch_configuration):
    reference_particles = ptg.generate_from_range(approximator, bunch_configuration)
    ...
    shifted_particles = ptg.generate_from_range(approximator, bunch_configuration)
