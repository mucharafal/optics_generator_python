...
#ifndef ROOT_MultiDimensionalFitter
#define ROOT_MultiDimensionalFitter
...
private:
   ...
   static MultiDimensionalFitter* fgInstance; //! Static instance
protected:
   ...
   virtual Bool_t   TestFunction(Double_t squareResidual,
                                 Double_t dResidur);
public:
   MultiDimensionalFitter();
   MultiDimensionalFitter(const MultiDimensionalFitter &in);
   const MultiDimensionalFitter &operator=(const MultiDimensionalFitter &in);
   //TMultiDimFet(TMultiDimFit_wrapper &in);

   MultiDimensionalFitter(Int_t dimension,
                EMDFPolyType type=kMonomials,
                Option_t *option="");
   virtual ~MultiDimensionalFitter();
   ...
   static MultiDimensionalFitter* Instance()               { return fgInstance; }
   ...
   ClassDef(MultiDimensionalFitter,2) // Multi dimensional fit class
};
#endif