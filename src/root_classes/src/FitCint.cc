...
#define R__DICTIONARY_FILENAME dOdIstubdIFitCint
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TMultiDimFet*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TMultiDimFet", ::TMultiDimFet::Class_Version(), "TMultiDimFet.h", 27,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::LHCOpticsApproximator*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("LHCOpticsApproximator", ::LHCOpticsApproximator::Class_Version(), "LHCOpticsApproximator.h", 39,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::LHCApertureApproximator*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("LHCApertureApproximator", ::LHCApertureApproximator::Class_Version(), "LHCOpticsApproximator.h", 118,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TNtupleDcorr*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TNtupleDcorr", ::TNtupleDcorr::Class_Version(), "TNtupleDcorr.h", 30,
...
"interface",
"/usr/include/root",
"/home/rafalmucha/Pobrane/optic/opticsGenerator/",
0
    };
...
class __attribute__((annotate(R"ATTRDUMP(Aperture approximator)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$LHCOpticsApproximator.h")))  LHCApertureApproximator;
namespace std{template <typename _Tp> class __attribute__((annotate("$clingAutoload$bits/allocator.h")))  __attribute__((annotate("$clingAutoload$string")))  allocator;
}
class __attribute__((annotate(R"ATTRDUMP(Proton transport approximator)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$LHCOpticsApproximator.h")))  LHCOpticsApproximator;
class __attribute__((annotate(R"ATTRDUMP(Multi dimensional fit class)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$TMultiDimFet.h")))  TMultiDimFet;
class __attribute__((annotate(R"ATTRDUMP(A simple tree with branches of floats.)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$TNtupleDcorr.h")))  TNtupleDcorr;
)DICTFWDDCLS";
